...
public class SQLStrings {
	...
	protected static String estadoInscripcion = "select * from inscripcion i where idCarrera = ? and (estadoInscripcion = 'Inscrito' or estadoInscripcion = 'Inscrito-Club') order by fechaInscripcion, estadoInscripcion";
	...
	protected static String numAtletasInscritosXCarrera = "select count(*) as cont from inscripcion where idCarrera = ? and (estadoInscripcion = 'Inscrito' or estadoInscripcion = 'Inscrito-Club')";

	// count atletas inscritos

	protected static String listaAtletasInscritosEnXCarrera = "select a.* from inscripcion i, atleta a where idCarrera = ? and a.idAtleta = i.idAtleta and (estadoInscripcion = 'Inscrito' or estadoInscripcion = 'Inscrito-Club') order by fechaInscripcion";

	// Count atletas cancelados
	protected static String numAtletasCanceladosXCarrera = "select count(*) as cont from inscripcion where idCarrera = ? and estadoInscripcion = 'Cancelado'";
	...
	public static String insertCarreraValues = "insert into carrera(idCarrera, nombre, fecha,fechaInicioIns, tipo, distancia, cuota, fechaFinInsc, plazasDisp, maxPlazas, listaDeEspera, ptoCorte1, ptoCorte2, ptoCorte3, ptoCorte4, ptoCorte5) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
