...
public class SQLStrings {
    ...
    public static String insertAtletaPredefinido10 = "Insert into atleta values ('idJaina', 'dniJaina', 'Jaina Valiente', 30, 'F', 0, 'Jaina@gmail.com');";
    ...
    public static String insertInscripcionPredefinida6 = "Insert into inscripcion values ('idIllidan', 'idMaratonMadrid', '7', ?, 'Cancelado', 'Tarjeta', 'NP', 'Junior', '', 'PP','18','28','38','48','58');";
    public static String insertInscripcionPredefinida7 = "Insert into inscripcion values ('idJaina', 'idMaratonMadrid', '8', ?, 'Cancelado', 'Tarjeta', 'NP', 'Veterano', '', 'PP','20','30','40','50','60');";
